...
<head>
    ...
    @if(file_exists(public_path('assets/css/studybuddy-admin-everywhere.css')))
        <link rel="stylesheet" href="{{ asset('assets/css/studybuddy-admin-everywhere.css') }}?v={{ filemtime(public_path('assets/css/studybuddy-admin-everywhere.css')) }}">
    @endif
...
<body class="sb-simple-admin-body sb-admin-body">
