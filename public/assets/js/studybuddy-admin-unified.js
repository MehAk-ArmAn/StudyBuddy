(() => {
    ...
    // Screens that already ship a purpose-built layout opt out by marking
    // themselves with data-admin-skip-unified. Wrapping their controls in
    // generated "editing blocks" would duplicate headings and bury the real
    // page actions.
    if (root.querySelector('[data-admin-skip-unified]')) {
        return;
    }
