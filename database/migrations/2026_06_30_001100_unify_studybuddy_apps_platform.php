...
return new class extends Migration
{
    ...
    private function seedSettings(): void
    {
        ...
        $settings = [
            ...
            ['setting_key' => 'default_public_theme_note', 'label' => 'Default Public Theme Note', 'group_name' => 'brand', 'setting_value' => 'The public website always returns to the default Cosmic Dolphin galaxy style after logout.', 'field_type' => 'textarea', 'help_text' => 'Internal reminder for public theme behavior.', 'is_public' => true, 'sort_order' => 105],
        ];
    ...
    private function prepareApp(array $app): array
    {
        ...
        $app['safety_note'] = $app['safety_note'] ?? 'StudyBuddy keeps this app connected to safe account rules, role-aware access, verified actions, and admin-controlled content.';
        ...
        $app['platform_notes'] = $app['platform_notes'] ?? 'Web play and downloads appear here when the admin adds approved links.';
