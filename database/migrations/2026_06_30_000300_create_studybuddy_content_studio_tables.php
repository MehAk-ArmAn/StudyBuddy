        ...
        $pages = [
            [
                ...
                'content_blocks' => json_encode([
                    ['type'=>'stats','title'=>'Today at a glance','items'=>[
                        ['label'=>'Sessions','value'=>'Short'], ['label'=>'Activities','value'=>'Focused'], ['label'=>'Next steps','value'=>'Clear']
                    ]],
                    ...
                    ['type'=>'cards','title'=>'What learners can do here','items'=>[
                        ...
                        ['icon'=>'🎮','title'=>'Open mini apps','description'=>'Move from your plan into a focused StudyBuddy learning activity.'],
            ...
            [
                ...
                'content_blocks' => json_encode([
                    ...
                    ['type'=>'cards','title'=>'Ways to support learning','items'=>[
                        ['icon'=>'🛡️','title'=>'Supervision tools','description'=>'Use clear account connections and age-appropriate guidance to support safer learning.'],
            ...
            [
                ...
                'subtitle' => 'Create learner-friendly lesson outlines, activities, and mini missions for classroom practice.',
                ...
                'content_blocks' => json_encode([
                    ...
                    ['type'=>'cards','title'=>'Classroom planning tools','items'=>[
            ...
            [
                ...
                'content_blocks' => json_encode([
                    ['type'=>'faq','title'=>'Common questions','items'=>[
                        ...
                        ['question'=>'Can parents use it?','answer'=>'Yes. Parents can use role-specific guidance, connect learner accounts with approval, and support calm routines.'],
                        ['question'=>'Can teachers use it?','answer'=>'Yes. Teachers can plan classroom activities and use StudyBuddy learning apps for focused practice.'],
                    ]],
            ...
            [
                ...
                'hero_badge' => 'Browser play + store links',
                ...
                'content_blocks' => json_encode([
                    ['type'=>'split','title'=>'Two ways to use apps','items'=>[
                        ['title'=>'Play on web','description'=>'Browser versions open directly when an app offers one.'],
                        ['title'=>'Download app/game','description'=>'Store links appear for the devices each app supports.'],
                    ]],
                    ['type'=>'app_catalog','title'=>'Connected mini-app catalog','description'=>'Browse StudyBuddy apps and choose the version that works for your device.'],
                ]),
            ],
        ];
