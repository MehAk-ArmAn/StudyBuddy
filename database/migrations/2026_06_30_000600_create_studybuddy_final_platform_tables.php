...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $settings = [
            ...
            ['setting_key' => 'final_launch_note', 'label' => 'Final Launch Note', 'group_name' => 'readiness', 'setting_value' => 'Final app hosting, store uploads, and playable builds should be connected after each mini-app is packaged and tested.', 'field_type' => 'textarea', 'help_text' => 'Internal final phase note.', 'sort_order' => 40],
        ];
