...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedMedia(): void
    {
        foreach ([
            ...
            ['Planner City Icon', 'homepage-paths/path-teachers.png'], ['Quiz Galaxy Icon', 'homepage-paths/path-apps.png'],
            ['Shapes Lab Icon', 'apps/app-shapes-lab.png'], ['Flashcard Castle Icon', 'apps/app-flashcard-castle.png'],
            ['Purple Planet', 'decor/planets/planet-purple-lg.png'], ['Ringed Planet', 'homepage-paths/path-parents.png'],
        ] as [$title, $path]) {
    ...
    private function seedHomepage(): void
    {
        ...
        $this->section('hero','hero',1,'Magical learning universe','Learn. Play. Grow. Your Way.','A bright cosmic learning world where students practice, focus, read, plan, and grow through playful mini experiences.','Built for curious kids, confident parents, and classroom-friendly routines.',$this->assetBase.'hero/hero-dolphin-book.png','See what we do','#what-we-do','Explore apps','/apps',['highlight'=>'Your Way','bubble_one'=>'Daily wins ✨','bubble_two'=>'Focus mode 🌙','bubble_three'=>'Tiny quests 🚀']);
        ...
        foreach ([['apps','Apps','Explore all StudyBuddy mini apps.','🚀',$this->assetBase.'homepage-paths/path-apps.png','/apps',1],['parents','Parents','Understand routines, trust, and growth.','💜',$this->assetBase.'homepage-paths/path-parents.png','/for-parents',2],['teachers','Teachers','See classroom-friendly learning energy.','🎓',$this->assetBase.'homepage-paths/path-teachers.png','/for-teachers',3],['support','Support','Get help, contact, and safety info.','✨',$this->assetBase.'homepage-paths/path-support.png','/support',4]] as [$key,$title,$subtitle,$badge,$image,$url,$sort]) $this->item($paths,$key,$title,$subtitle,null,$image,$badge,'Open',$url,$sort);
    ...
    {
        $page=$this->page('apps','Apps','Apps','Explore the mini app universe','Choose a learning world for math, spelling, reading, focus, planning, quizzes, shapes, or flashcards.','Every app card, description, image, and button is editable from admin.',$this->assetBase.'homepage-paths/path-apps.png','Contact us','/contact-us',1);
