...
class PublishReadyContentSeeder extends Seeder
{
    ...
    private function seedHomepage(): void
    {
        ...
        foreach ([
            ...
            ['support', 'Support', 'Find help, privacy, deletion, and contact options.', 'Everything important is easy to reach whenever you need it.', $this->assetBase.'homepage-paths/path-support.png', 'Get Support', '/support', 4],
        ...
        $this->section('cta', 'cta', 7, 'Ready to make study feel lighter?', 'Start your StudyBuddy.fun journey.', 'Explore the mini app universe, create a role-based dashboard, and build a learning flow that feels clear from the first click.', 'Create an account, choose your role, and keep your learning tools together as StudyBuddy grows.', $this->assetBase.'hero/hero-dolphin-book.png', 'Create Account', '/register', 'Contact Us', '/contact-us');
    }
    ...
    private function seedPages(): void
    {
        ...
        $this->simplePage('for-teachers', 'For Teachers', 'Teachers', 'A classroom-friendly learning layer.', 'StudyBuddy.fun can support practice, review, focus, planning, and learner confidence in a polished education-friendly environment.', 'Teacher accounts are verification-based and intentionally limited. A teacher can request student supervision after verification, and learners approve the connection.', $this->assetBase.'homepage-paths/path-teachers.png', 3, [
            ...
            ['Flexible classroom routines', 'Shape each session around your class.', 'Use class pages, resources, activities, and learning pathways to support focused practice.'],
        ]);
        ...
        $this->legalPage('privacy-policy', 'Privacy Policy', 'Privacy', 'Privacy Policy', 'StudyBuddy.fun is designed with trust, clarity, and safe account handling in mind.', 'This policy explains what information StudyBuddy.fun may collect, how it may be used, and how users can request support or deletion.', 5, [
            ...
            ['How we use information', 'We use information to create accounts, show role-based dashboards, provide support, improve safety, manage verification, and keep the website working correctly.'],
        ...
        $this->simplePage('support', 'Support', 'Support', 'Need help with StudyBuddy.fun?', 'Support is here for learners, parents, teachers, and independent learners.', 'Start with the topic that matches your question. The product is designed to keep help clear, safe, and easy to find.', $this->assetBase.'homepage-paths/path-support.png', 8, [
            ...
            ['Learning visuals', 'Friendly illustrations make each area easy to recognise.', 'Images are chosen to support clarity and keep the experience welcoming.'],
        ]);
    }
    ...
    private function simplePage(string $slug, string $title, string $label, string $hero, string $subtitle, string $body, string $image, int $sort, array $cards): void
    {
        ...
        $section = $this->pageSection($page, 'main_cards', 'cards', 1, $label, 'What this page covers', 'Clear information for learners, families, and teachers.', null, null);
