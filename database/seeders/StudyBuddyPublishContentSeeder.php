...
class StudyBuddyPublishContentSeeder extends Seeder
{
    ...
    private function miniApps(): void
    {
        ...
        if (!$table) return;
        // Demo apps removed: the real catalogue is built in the Apps CMS.
        $apps = [];
        $sort = 10;
    ...
    private function platform(): void
    {
        if (Schema::hasTable('studybuddy_platform_settings')) {
            $rows = [
                ...
                ['Launch', 'Readiness', 'launch_message', 'StudyBuddy brings learning apps, dashboards, points, and role-based guidance together in one accessible, family-friendly platform.'],
            ];
            $sort = 10;
