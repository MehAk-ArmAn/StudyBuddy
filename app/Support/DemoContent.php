...
class DemoContent
{
    ...
    {
        return collect([
            (object) ['title' => 'Math Quest', 'slug' => 'math-quest', 'subject' => 'Math', 'age_band' => 'Primary & Secondary', 'description' => 'Practice math in a fun and interactive way with glowing challenge planets.', 'card_tone' => 'violet', 'status' => 'live', 'launch_path' => '/apps/math-quest/play', 'hero_metric' => '4.9', 'image_label' => 'APP_CARD_IMAGE_MATH', 'image_path' => 'assets/studybuddy/app-math-quest.png', 'sort_order' => 1],
            (object) ['title' => 'Spelling Sprint', 'slug' => 'spelling-sprint', 'subject' => 'English', 'age_band' => 'Primary', 'description' => 'Improve spelling and vocabulary with rocket-fast word missions.', 'card_tone' => 'blue', 'status' => 'live', 'launch_path' => null, 'hero_metric' => '4.7', 'image_label' => 'APP_CARD_IMAGE_SPELLING', 'image_path' => 'assets/studybuddy/app-spelling-sprint.png', 'sort_order' => 2],
            (object) ['title' => 'Reading Garden', 'slug' => 'reading-garden', 'subject' => 'Reading', 'age_band' => 'Primary', 'description' => 'Read stories and grow vocabulary inside a magical floating garden.', 'card_tone' => 'green', 'status' => 'live', 'launch_path' => null, 'hero_metric' => '4.8', 'image_label' => 'APP_CARD_IMAGE_READING', 'image_path' => 'assets/studybuddy/app-reading-garden.png', 'sort_order' => 3],
            (object) ['title' => 'Focus Forest', 'slug' => 'focus-forest', 'subject' => 'Focus', 'age_band' => 'All ages', 'description' => 'Stay focused and calm while friendly forest spirits keep time.', 'card_tone' => 'teal', 'status' => 'live', 'launch_path' => null, 'hero_metric' => '4.8', 'image_label' => 'APP_CARD_IMAGE_FOCUS', 'image_path' => 'assets/studybuddy/app-focus-forest.png', 'sort_order' => 4],
            (object) ['title' => 'Planner City', 'slug' => 'planner-city', 'subject' => 'Planning', 'age_band' => 'Secondary', 'description' => 'Organize tasks and homework with a neon city mission board.', 'card_tone' => 'cyan', 'status' => 'live', 'launch_path' => null, 'hero_metric' => '4.6', 'image_label' => 'APP_CARD_IMAGE_PLANNER', 'image_path' => 'assets/studybuddy/app-planner-city.png', 'sort_order' => 5],
            (object) ['title' => 'Quiz Galaxy', 'slug' => 'quiz-galaxy', 'subject' => 'Quizzes', 'age_band' => 'All ages', 'description' => 'Test knowledge and earn stars with fast-paced quiz rounds.', 'card_tone' => 'gold', 'status' => 'live', 'launch_path' => null, 'hero_metric' => '4.7', 'image_label' => 'APP_CARD_IMAGE_QUIZ', 'image_path' => 'assets/studybuddy/app-quiz-galaxy.png', 'sort_order' => 6],
            (object) ['title' => 'Shapes Lab', 'slug' => 'shapes-lab', 'subject' => 'Geometry', 'age_band' => 'Primary', 'description' => 'Learn shapes through playful geometry experiments and puzzles.', 'card_tone' => 'orange', 'status' => 'live', 'launch_path' => null, 'hero_metric' => '4.6', 'image_label' => 'APP_CARD_IMAGE_SHAPES', 'image_path' => 'assets/studybuddy/app-shapes-lab.png', 'sort_order' => 7],
            (object) ['title' => 'Flashcard Castle', 'slug' => 'flashcard-castle', 'subject' => 'Memory', 'age_band' => 'All ages', 'description' => 'Create, study, and master flashcards inside a magic castle.', 'card_tone' => 'pink', 'status' => 'live', 'launch_path' => null, 'hero_metric' => '4.8', 'image_label' => 'APP_CARD_IMAGE_FLASHCARDS', 'image_path' => 'assets/studybuddy/app-flashcard-castle.png', 'sort_order' => 8],
        ]);
    }
