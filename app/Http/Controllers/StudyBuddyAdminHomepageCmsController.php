...
class StudyBuddyAdminHomepageCmsController extends Controller
{
    public function index(): View
    {
        ...
        $visuals = $databaseVisuals
            ->merge([
                'https://raw.githubusercontent.com/MehAk-ArmAn/StudyBuddy-Imgs/main/hero/hero-dolphin-book.png',
                'https://raw.githubusercontent.com/MehAk-ArmAn/StudyBuddy-Imgs/main/homepage-paths/path-apps.png',
                'https://raw.githubusercontent.com/MehAk-ArmAn/StudyBuddy-Imgs/main/homepage-paths/path-learning.png',
                'https://raw.githubusercontent.com/MehAk-ArmAn/StudyBuddy-Imgs/main/homepage-paths/path-parents.png',
                'https://raw.githubusercontent.com/MehAk-ArmAn/StudyBuddy-Imgs/main/homepage-paths/path-teachers.png',
            ])
            ->unique()
            ->values()
            ->take(18);
