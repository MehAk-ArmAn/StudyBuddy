...
class StudyBuddyAdminHealthController extends Controller
{
    public function index(): View
    {
        ...
        foreach ([
            ...
            public_path('web-apps') => 'Published web apps directory',
        ] as $path => $label) {
            $exists = is_dir($path);
            ...
            $checks->push([
                ...
                'detail' => $writable ? 'Directory exists and is writable.' : ($exists ? 'Directory exists but is not writable.' : 'Directory is missing.'),
            ]);
        }
