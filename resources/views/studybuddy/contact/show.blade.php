...
<div class="sb-contact-page">
    <section class="sb-contact-hero">
        ...
        <aside>
            ...
            <p>Your message goes securely to the StudyBuddy support team.</p>
        </aside>
    </section>
    ...
    <section class="sb-contact-grid">
        ...
        <aside class="sb-contact-side">
            <article><strong>Safety concern?</strong><p>Choose Safety Concern so our support team can prioritize it.</p></article>
