...
<div class="sb-contact-final">
    <section class="sb-contact-final-hero">
        ...
        <div class="sb-contact-final-card">
            <img src="https://github.com/MehAk-ArmAn/StudyBuddy-Imgs/blob/main/hero/hero-dolphin-book.png?raw=true" alt="StudyBuddy support">
    ...
    <section class="sb-contact-final-grid">
        <form method="POST" action="{{ route('studybuddy.contact.store') }}" class="sb-contact-final-form">
            ...
            <div class="form-head">
                ...
                <span>Your message will be saved in the admin Control Room.</span>
            </div>
        ...
        <aside class="sb-contact-final-side">
            <article>
                ...
                <p>Choose Safety Concern so it is marked as priority in the admin inbox.</p>
            </article>
