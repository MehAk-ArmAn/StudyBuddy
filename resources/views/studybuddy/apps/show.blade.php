...
<main class="sb-app-detail-shell">
    ...
    <section class="sb-platform-panel">
        <div>
            ...
            <p>{{ $app->platform_notes ?: 'Web play and app downloads appear here when the admin adds approved links.' }}</p>
        </div>
    ...
    <section class="sb-app-preview-note">
        ...
        <p class="sb-safety-note">{{ $app->safety_note ?: 'StudyBuddy keeps app actions connected to safe account rules, role-aware access, verified actions, and admin-controlled content.' }}</p>
    </section>
