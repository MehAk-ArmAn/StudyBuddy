...
<div class="sb-apps-shell" data-sb-unified-apps>
    <section class="sb-apps-hero">
        ...
        <aside class="sb-apps-orbit-card" aria-label="StudyBuddy app universe summary">
            ...
            <p>learning worlds for short, focused practice</p>
        </aside>
    </section>
    ...
    <section class="sb-apps-grid" aria-label="StudyBuddy app list">
        ...
        @empty
            <div class="sb-app-empty">
                ...
                <p>Try clearing the filters or check back as new learning worlds arrive.</p>
            </div>
        @endforelse
    </section>
    ...
    <section class="sb-apps-guest-note">
        ...
        <div class="sb-guest-grid">
            ...
            <div><strong>Support for every role</strong><p>Students, parents, teachers, and independent learners each get guidance suited to them.</p></div>
        </div>
    </section>
</div>
