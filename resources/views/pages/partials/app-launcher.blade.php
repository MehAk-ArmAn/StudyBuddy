...
<section class="launcher-shell" data-app-launcher>
    ...
    <div class="launcher-personalizer" data-launcher-recommender>
        ...
        <div class="choice-cloud" role="group" aria-label="Choose role">
        ...
        <div class="time-cloud" role="group" aria-label="Choose time">
    ...
    <div class="launcher-tabs" role="tablist" aria-label="Filter apps">
    ...
    <div class="launcher-grid">
        @foreach ($apps as $item)
            ...
            @endphp
            <article class="launcher-card" data-app-card data-category="{{ $category }}" data-title="{{ e($item->title) }}" data-subtitle="{{ e($item->subtitle) }}" data-body="{{ e($item->body) }}" data-image="{{ e($image) }}">
                <div class="launcher-card-art">
                    @if ($image)<img src="{{ $image }}" alt="{{ $item->title }}">@endif
                    @if ($item->badge_text)<span>{{ $item->badge_text }}</span>@endif
                </div>
...
<div class="mission-modal" data-mission-modal hidden>
    <div class="mission-dialog" role="dialog" aria-modal="true" aria-labelledby="mission-title">
        ...
        <div class="mission-actions">
            <a class="btn btn-primary" href="/register">Save to My Quest</a>
