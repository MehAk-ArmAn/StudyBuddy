...
<section class="product-board reveal-on-load" aria-labelledby="product-board-title">
    ...
    <main class="product-collage">
        ...
        <article class="pb-panel pb-buddy"><b>08</b><small>Buddy Customization (Like Blooket)</small><div><img src="{{ $asset('hero-dolphin-book.png') }}" alt=""><section>@foreach(['','','','','','','','',''] as $icon)<span>{{ $icon }}<small>100</small></span>@endforeach</section></div><button>Save Changes</button></article>
