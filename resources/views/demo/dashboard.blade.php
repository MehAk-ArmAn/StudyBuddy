...
@php
    ...
    $adminApps = [
        ['name' => 'Math Quest', 'img' => 'app-math-quest.png', 'category' => 'Math', 'users' => '4,210', 'lessons' => '120', 'status' => 'Live'],
        ['name' => 'Spelling Sprint', 'img' => 'app-spelling-sprint.png', 'category' => 'English', 'users' => '3,850', 'lessons' => '95', 'status' => 'Live'],
        ['name' => 'Reading Garden', 'img' => 'app-reading-garden.png', 'category' => 'Reading', 'users' => '4,120', 'lessons' => '110', 'status' => 'Live'],
        ['name' => 'Focus Forest', 'img' => 'app-focus-forest.png', 'category' => 'Mindfulness', 'users' => '2,980', 'lessons' => '80', 'status' => 'Live'],
        ['name' => 'Quiz Galaxy', 'img' => 'app-quiz-galaxy.png', 'category' => 'General', 'users' => '4,560', 'lessons' => '150', 'status' => 'Live'],
        ['name' => 'Shapes Lab', 'img' => 'app-shapes-lab.png', 'category' => 'Math', 'users' => '3,210', 'lessons' => '90', 'status' => 'Live'],
        ['name' => 'Flashcard Castle', 'img' => 'app-flashcard-castle.png', 'category' => 'General', 'users' => '2,750', 'lessons' => '70', 'status' => 'Maintenance'],
    ];
@endphp
    ...
    <main class="admin-pro-main">
        <section class="admin-pro-shell">
            ...
            <section class="admin-apps-panel" aria-labelledby="admin-apps-title">
                <div class="admin-panel-heading"><div><h2 id="admin-apps-title">▦ Manage Apps</h2><p>View, manage and configure all learning apps in your platform.</p></div><label><span>⌕</span><input type="search" placeholder="Search apps..."></label><button type="button">＋ Add New App</button></div>
                ...
                <div class="admin-table-footer"><span>Showing 1 to 7 of 7 apps</span><div><button>‹</button><button class="is-active">1</button><button>›</button></div></div>
            </section>
